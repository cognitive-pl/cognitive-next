<template>
  <article>
    ...
    <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://nety.pl/policy">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
    <h2 style="text-align:center">§1 Definicje</h2>
    <ul>
        <li>
          <p><strong>Serwis</strong> - serwis internetowy "Cognitive" działający pod adresem https://cognitiveapp.pl</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Aleksander Skubała" zamieszkała w Poznaniu, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
        </li>
        <li>
    ...
    <p>W przypadku realizacji płatności on-line, wszelkie dane dotyczące płatności przekazywane są bezpośrednio przez Użytkownika podmiotowi realizującemu płatność - <a rel="nofollow external" href="">PayPal</a>. Wybrane dane niezbędne do realizacji transakcji są następnie przekazywane przez ten podmiot Administratorowi. Przekazanie danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
    <br />
    ...
    <ul>
        ...
        <li>Dane osobowe są wykorzystywane do zautomatyzowanego podejmowania decyzji (profilowania).<br />Profilowanie danych osobowych nie wywołuje skutków prawnych lub w podobny sposób istotnie nie wpływa na osobę, której dane podlegają automatycznemu podejmowaniu decyzji.</li>
    ...
    <ul>
        <li>
          <p><strong>Adres poczty elektronicznej</strong> - alexskubala@gmail.com</p>
        </li>
        <li>
          <p><strong>Połączenie telefoniczne</strong> - +48 782 832 383</p>
        </li>
        <li>
